...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{input\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{n}{strides}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{output\PYZus{}layer} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{input\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{n}{strides}\PY{p}{)}
            \PY{k}{return} \PY{n}{output\PYZus{}layer}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{small\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Upsample the small input layer using the bilinear\PYZus{}upsample() function.}
            \PY{n}{upsampled\PYZus{}small\PYZus{}ip\PYZus{}layer} \PY{o}{=} \PY{n}{bilinear\PYZus{}upsample}\PY{p}{(}\PY{n}{small\PYZus{}ip\PYZus{}layer}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Concatenate the upsampled and large input layers using layers.concatenate}
            \PY{n}{concatenated} \PY{o}{=} \PY{n}{layers}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{[}\PY{n}{upsampled\PYZus{}small\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{]}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} Add some number of separable convolution layers}
            \PY{n}{conv\PYZus{}layer\PYZus{}1} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{concatenated}\PY{p}{,} \PY{n}{filters}\PY{p}{)}
            \PY{n}{conv\PYZus{}layer\PYZus{}2} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{conv\PYZus{}layer\PYZus{}1}\PY{p}{,} \PY{n}{filters}\PY{p}{)}
            \PY{n}{output\PYZus{}layer} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{conv\PYZus{}layer\PYZus{}2}\PY{p}{,} \PY{n}{filters}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{fcn\PYZus{}model}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{n}{num\PYZus{}classes}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{encoder\PYZus{}block1} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{encoder\PYZus{}block2} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{encoder\PYZus{}block1}\PY{p}{,}\PY{l+m+mi}{64}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
            ...
            \PY{n}{one\PYZus{}by\PYZus{}one\PYZus{}conv} \PY{o}{=} \PY{n}{conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{encoder\PYZus{}block2}\PY{p}{,} \PY{l+m+mi}{256}\PY{p}{,} \PY{n}{kernel\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} TODO: Add the same number of Decoder Blocks as the number of Encoder Blocks}
            \PY{n}{decoder\PYZus{}block1} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{one\PYZus{}by\PYZus{}one\PYZus{}conv}\PY{p}{,} \PY{n}{encoder\PYZus{}block1}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{)}
            \PY{n}{x} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{decoder\PYZus{}block1}\PY{p}{,} \PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{)}
...
work with.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{learning\PYZus{}rate} \PY{o}{=} \PY{l+m+mf}{0.01}
        \PY{n}{batch\PYZus{}size} \PY{o}{=} \PY{l+m+mi}{40}
...
199/200 [============================>.] - ETA: 8s - loss: 0.1381 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1888s - loss: 0.1377 - val\_loss: 0.1066
Epoch 2/20
199/200 [============================>.] - ETA: 9s - loss: 0.0446 
    \end{Verbatim}
...
199/200 [============================>.] - ETA: 9s - loss: 0.0197 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1952s - loss: 0.0196 - val\_loss: 0.0264
Epoch 19/20
199/200 [============================>.] - ETA: 9s - loss: 0.0197 
    \end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1959s - loss: 0.0196 - val\_loss: 0.0314
Epoch 20/20
199/200 [============================>.] - ETA: 8s - loss: 0.0185 
    \end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1919s - loss: 0.0185 - val\_loss: 0.0885

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} <tensorflow.contrib.keras.python.keras.callbacks.History at 0x7ff114494710>
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} Save your trained model weights}
...
identify the target while following them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} If you need to load a model which you previously trained you can uncomment the codeline that calls the function below.}
         
         \PY{n}{weight\PYZus{}file\PYZus{}name} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{model\PYZus{}weights}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{restored\PYZus{}model} \PY{o}{=} \PY{n}{model\PYZus{}tools}\PY{o}{.}\PY{n}{load\PYZus{}network}\PY{p}{(}\PY{n}{weight\PYZus{}file\PYZus{}name}\PY{p}{)}
\end{Verbatim}
...
it for different runs. For example, `run\_1', `run\_2' etc.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{run\PYZus{}num} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{run\PYZus{}1}\PY{l+s+s1}{\PYZsq{}}
...
some sample images from the predictions in the validation set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} images while following the target}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} images while at patrol without target}
...
discussed during the Prediction step.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} Scores for while the quad is following behind the target. }
...
number true positives: 528, number false positives: 0, number false negatives: 11
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} Scores for images while the quad is on patrol and the target is not visable}
...
number true positives: 0, number false positives: 31, number false negatives: 0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} This score measures how well the neural network can detect the target from far away}
...
number true positives: 149, number false positives: 0, number false negatives: 152
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} Sum all the true positives, etc from the three datasets to get a weight for the score}
...
0.7772675086107922
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} The IoU for the dataset that never includes the hero is excluded from grading}
...
0.5405750227640069
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} And the final grade score is }
